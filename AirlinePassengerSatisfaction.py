...
def plot_confusion_matrix(cm, classes,
    ...
    plt.xticks(tick_marks, classes, rotation=30, size = 14)
...
# Confusion matrix
plot_confusion_matrix(conf_matrix, classes = lenc.inverse_transform(target_possibilities),
                      title = 'Customer Satisfaction Confusion Matrix')
